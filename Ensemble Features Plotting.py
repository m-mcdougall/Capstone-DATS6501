...
predictions = pd.read_csv(wd+'\\Data\\Features\\Results\\reordered_ensemble_predictions.csv',index_col=0,)
...
focus_word = 'visit'#neg.Feature.iloc[0]
sentiment = 'NEGATIVE'
sentiment = 'POSITIVE'
...
for focus_word in pos.Feature.iloc[0:13]:
...
train_set = pd.read_csv(wd+'\\Data\\Cleaned\\Split\\New_Samples_reordered_3000_train.csv', index_col = 0)
...
train_set['Walk'] = train_set.Review_Body.str.slice(37,39)
...
#Moderate degree of correlation between the frequency of high walkability and the mean review score 0.46335286
